...
def fruits_dataframe():
    ...
    data = {
        ...
        'item_id': ['apple', 'banana', 'orange', 'banana', 'orange', 'grape', 'apple', 'banana', 'grape', 'apple', 'grape', 'banana', 'orange'],
        'description': ['Description of apple', 'Description of banana', 'Description of orange', 'Description of banana', 'Description of orange', 'Description of grape', 'Description of apple', 'Description of banana', 'Description of grape', 'Description of apple', 'Description of grape', 'Description of banana', 'Description of orange']
    }
